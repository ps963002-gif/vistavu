        ...
        <div className="grid h-[520px] lg:grid-cols-[47%_53%]">
          ...
          <div className="relative overflow-hidden bg-[#EEF5FD] px-12 pt-14">
            ...
            <div className="relative z-10">
              ...
              <h2 className="max-w-[360px] text-[31px] leading-[1.28] tracking-[-0.02em] text-[#222]">
              ...
              {testimonials.map((item, index) => (
                <SwiperSlide key={index}>
                  ...
                  <div className="flex h-[440px] flex-col">
                    ...
                    <div className="mt-6 h-[3px] w-[36px] rounded-full bg-[#2F80ED]" />
                    ...
                    <div className="mt-6">
                      ...
                      <p className="mt-1 text-[13px] text-[#B7C3D7]">
                        {item.role}
                      </p>

                      <div className="relative mt-5 h-[48px] w-[120px]">
                        <Image
                          src={item.logo}
                          alt={item.name}
                          fill
